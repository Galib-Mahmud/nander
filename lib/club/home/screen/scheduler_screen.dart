      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildPeriodCard('4 weeks', 'Short focus period', true),
              _buildPeriodCard('8 weeks', 'One block', false, hasCheckmark: true),
              _buildPeriodCard('12 weeks', 'Quarter', false),
              _buildPeriodCard('26 weeks', 'Half season', false),
            ],
          ),
        ],
      ),
