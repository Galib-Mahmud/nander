      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFF1A2236), shape: BoxShape.circle),
            child: Stack(
              children: [
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Keep up with your rewards and rankings.',
          ...
          Expanded(
            child: Obx(() {
              ...
              if (controller.announcements.isEmpty) {
                return Center(child: Text('No announcements yet', style: TextStyle(color: Colors.white54)));
              }
          ...
          Obx(() => controller.isAdmin.value
            ...
            child: ElevatedButton(
              ...
              child: const Text('Add New Announcement', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            ),
          )
